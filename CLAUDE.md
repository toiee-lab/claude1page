...
- `/unsplash-image-finder` スキルを使用して、Unsplashの画像を検索し、その情報を使って設定する
...
- 適度にイメージ画像を挿入する
- ユーザーからの指定がない場合、イメージ画像は、unsplash.com で適切なものを `/unsplash-image-finder` スキルを使用して、Unsplashの画像を検索し、その情報を使って設定する
